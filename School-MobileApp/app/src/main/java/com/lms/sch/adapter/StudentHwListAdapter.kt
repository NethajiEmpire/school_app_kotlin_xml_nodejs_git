...
class StudentHwListAdapter (
    val mActivity: BaseActivity,
    val status : String,
    val list : ArrayList<GetHomeworkResponse.Result>,
    val onClickListener: OnClickListener
): RecyclerView.Adapter<StudentHwListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        if (list[position].markStatus == "completed" && list[position].status == "completed"){
            ...
            if (list[position].student != null && list[position].student!!.img_url != null ){
                ...
                UiUtils.loadImage(holder.binding.studentImg,R.drawable.ic_user_profile.toString())
            }
            ...
            when(list[position].status){
                "pending" -> {
                    holder.binding.completed.visibility = View.GONE
                    holder.binding.pending.visibility = View.VISIBLE
                ...
                "completed" -> {
                    ...
                    holder.binding.pending.visibility = View.GONE
