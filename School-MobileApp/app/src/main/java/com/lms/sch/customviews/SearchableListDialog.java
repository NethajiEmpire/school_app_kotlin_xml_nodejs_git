...
public class SearchableListDialog extends DialogFragment implements
    ...
    public ArrayList<String> liveList = new ArrayList<>();
        ...
        _listViewItems.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                for(int i=0;i<liveList.size();i++){
                    if(Objects.equals(liveList.get(i), listAdapter.getItem(position))){
...
//                _listViewItems.clearTextFilter();
         //   ((ArrayAdapter<String>) _listViewItems.getAdapter()).getFilter().filter(null);
            listAdapter.clear();
            listAdapter.addAll(liveList);
            listAdapter.notifyDataSetChanged();
        } else {
          // ((ArrayAdapter<String>) _listViewItems.getAdapter()).getFilter().filter(s);
            ...
            listAdapter.clear();
            Log.d("dhcvdc",""+keepList.size());
            listAdapter.addAll(keepList);
            listAdapter.notifyDataSetChanged();
        }
