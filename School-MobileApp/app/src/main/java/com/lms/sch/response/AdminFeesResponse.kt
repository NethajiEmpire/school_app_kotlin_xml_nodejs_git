...
class AdminFeesResponse : BaseModel() {
    @JsonProperty("data")
    ...
    class Result : Serializable {
        ...
        class Overall : Serializable{
            ...
            @JsonProperty("overallFees")
            var overallFees: Int? = 0

            @JsonProperty("overallCollectedPercent")
            var overallCollectedPercent: Int? = 0

            @JsonProperty("overallPendingPercent")
            var overallPendingPercent: Int? = 0

            @JsonProperty("overallOverduePercent")
            var overallOverduePercent: Int? = 0
