...
import com.lms.sch.response.GetComplaintSingleViewResponse.Result.SolvedBy
import com.lms.sch.response.GetComplaintSingleViewResponse.Result.StudentDetails
import java.io.Serializable

@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = true)
class GetComplaintResponse: BaseModel() {
    ...
    class Result : Serializable {
        ...
        class Rows : Serializable {
            ...
            var attachment: ArrayList<Any>? = null
